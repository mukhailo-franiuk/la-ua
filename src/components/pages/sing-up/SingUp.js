            ...
            <form className="w-1/2">
                <div className="space-y-12">
                    <div className="border-b border-gray-900/10 pb-12">
                        <h2 class="font-semibold text-gray-900 text-2xl">Створити свій профіль</h2>
                        <p className="mt-1 text-sm/6 text-gray-600">Невелика кількість питань і ви приєднаєтесь до нас!</p>
                            ...
                            <div className="sm:col-span-4">
                                ...
                                <div className="mt-2">
                                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                        ...
                                        <input type="text" name="username" id="username" autocomplete="username" className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm/6" placeholder="janesmith" />
                                    </div>
                                </div>
                            </div>
