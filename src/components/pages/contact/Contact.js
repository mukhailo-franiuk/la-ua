            ...
            <div className="flex flex-col justify-center items-center lg:w-3/5 md:w-4/5 w-full">
                ...
                <div className="w-full flex justify-center items-center my-1">
                    <p className="flex flex-row gap-3">
                        ...
                        Графік роботи: з 10:00 до 22:55
                    </p>
                </div>
            </div>
            <h2 className="mt-10 text-center w-full py-3 bg-gray-300 text-gray-900 font-bold text-2xl">Наші виробництва</h2>
            <div className="flex flex-col justify-center items-start lg:w-3/5 md:w-4/5 w-full">
                <ul className="my-10">
                    <li className="flex flex-row gap-2 my-1">
                        <svg className="w-6 h-6 text-yellow-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M7.833 2c-.507 0-.98.216-1.318.576A1.92 1.92 0 0 0 6 3.89V21a1 1 0 0 0 1.625.78L12 18.28l4.375 3.5A1 1 0 0 0 18 21V3.889c0-.481-.178-.954-.515-1.313A1.808 1.808 0 0 0 16.167 2H7.833Z" />
                        </svg>
                        Івана-Теодозія Куровця, 36
                    </li>
                    <li className="flex flex-row gap-2 my-1">
                        <svg className="w-6 h-6 text-yellow-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M7.833 2c-.507 0-.98.216-1.318.576A1.92 1.92 0 0 0 6 3.89V21a1 1 0 0 0 1.625.78L12 18.28l4.375 3.5A1 1 0 0 0 18 21V3.889c0-.481-.178-.954-.515-1.313A1.808 1.808 0 0 0 16.167 2H7.833Z" />
