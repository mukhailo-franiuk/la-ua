...
const Products = () => {
    ...
    return (
        <section className="bg-white p-3 sm:p-5">
                ...
                <div className="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
                    <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                        ...
                        <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                            <button
                                type="button"
                                className="flex items-center justify-center text-gray-900 hover:cursor-pointer hover:bg-yellow-400 focus:ring-4 hover:text-white focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 focus:outline-none"
                            ...
                            <div className="flex items-center space-x-3 w-full md:w-auto relative">
                                <button
                                    className="w-full md:w-auto flex items-center justify-center py-2 px-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200" type="button"
            ...
            <div className={`fixed z-50 w-full top-0 left-0 h-full overflow-hidden flex flex-col items-baseline  text-sm shadow-xl md:grid-cols-3 transition-all duration-700 ease-in-out ${isOpenInfoProduct ? "translate-y-0" : "-translate-y-full"}`}>
            ...
            <div className={`fixed z-50 w-full top-0 left-0 flex flex-col items-baseline text-sm md:grid-cols-3 transition-all duration-700 ease-in-out ${isOpenQuestion ? "translate-y-0" : "-translate-y-full"}`}>
                <div className="flex justify-center items-center w-full md:inset-0 h-modal md:h-full">
                    <div className="relative p-4 w-full max-w-md h-full md:h-auto">
                        <div className="relative p-4 text-center bg-yellow-400 rounded-lg shadow sm:p-5">
                            <button
                                onClick={() => setIsOpenAddQuestion(false)}
                                type="button"
                                className="text-gray-900 absolute top-2.5 right-2.5 bg-transparent hover:bg-yellow-500 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center">
                                <svg aria-hidden="true" className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                                <span className="sr-only">Close modal</span>
                            </button>
                            <svg className="text-gray-900 w-11 h-11 mb-3.5 mx-auto" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clipRule="evenodd"></path></svg>
                            <p className="mb-4 text-gray-900 ">Ви дійсно хочете видалити цю категорію?</p>
                            <div className="flex justify-center items-center space-x-4">
                                <button
                                    type="button"
                                    className="py-2 px-3 text-sm font-medium text-gray-50 bg-gray-900 rounded-lg border border-gray-200 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-gray-50 focus:z-10"
                                    onClick={() => {
