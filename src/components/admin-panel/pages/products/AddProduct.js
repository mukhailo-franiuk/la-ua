...
const AddProduct = (props) => {
    ...
    return (
        <div className="relative w-full lg:w-1/4 h-screen  p-4 overflow-y-auto bg-yellow-400">
            <h5 className="inline-flex items-center mb-6 text-sm font-semibold text-gray-900 uppercase w-full">Добавити продукт</h5>
            <button
                type="button"
            ...
            <form action="#" className="w-full" onSubmit={handleSubmit(addProductForm)}>
                ...
                <div className="flex justify-center w-full pb-4 space-x-4 sm:px-4 sm:mt-0">
                    <button type="submit" className="w-full justify-center text-white bg-gray-900 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                        Зберегти
                    </button>
                </div>
            </form>
