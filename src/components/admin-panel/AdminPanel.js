                        ...
                        >
                            ...
                            <div className="grid grid-cols-3 gap-4 p-4">
                                ...
                                >
                                    ...
                                    <div className="text-sm text-gray-900 dark:text-white">Продажі</div>
                                </a>
                                <Link
                                    to={`users-list`}
                                    className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group"
                                ...
                                >
                                    ...
                                    <div className="text-sm text-gray-900 dark:text-white">Юзери</div>
                                </Link>
                                <a
                                    href="#"
                                    className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group"
                    ...
                    <ul className="space-y-2">
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span className="ml-3">Список продуктів</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                            ...
                            >
                                ...
                                <span className="ml-3">Список акцій</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                            ...
                            >
                                ...
                                <span className="ml-3">Список категорій</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                            ...
                            >
                                ...
                                <span className="ml-3">Список вакансій</span>
                            </Link>
                        </li>
                        <li>
                            <a
                            ...
                            >
                                ...
                                <span className="flex-1 ml-3 whitespace-nowrap">Повідомлення</span>
                                <span
